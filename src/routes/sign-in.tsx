...
function RouteComponent() {
  ...
  const testimonials = [
    {
      quote:
        "NewsMonitor has transformed how our team stays on top of industry news. The webhook alerts integrate seamlessly with our Slack workflow.",
      author: "Sofia Davis",
    ...
    {
      quote:
        "The topic monitoring and email digests save me hours every week. I never miss important developments in my field anymore.",
      author: "Marcus Chen",
    ...
    {
      quote:
        "Finally, a news monitoring tool that actually works. The source credibility scoring helps us filter out noise and focus on reliable sources.",

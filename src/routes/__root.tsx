...
export const Route = createRootRouteWithContext<{
  ...
  head: () => ({
    meta: [
      ...
      ...seo({
        title: "NewsMonitor | Track Topics, Get Alerts, Stay Informed",
        description: `NewsMonitor helps you track news topics, get real-time alerts, and never miss important stories. Monitor keywords, receive webhook notifications, and stay ahead of the news.`,
      }),
    ],
    links: [
